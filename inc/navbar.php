            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Resources
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="https://spleefleague.com/forums/link-forums/ban-appeal-form.51/">Appeal a Ban</a>
                        </li>
                        <li><a href="https://spleefleague.com/forums/link-forums/wildfire-application-open.52/">Apply
                                for Builder</a></li>
